	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate pb-4">
				...
				<p class="breadcrumbs">
<p class="breadcrumbs"><span class="mr-2"><a href="../">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="../Notice">Notice <i class="ion-ios-arrow-forward"></i></a></span> <span>Notice Insert<i class="ion-ios-arrow-forward"></i></span></p>
				</p>
			</div>
		</div>
	</div>
