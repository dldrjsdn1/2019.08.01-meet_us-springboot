...
<body data-spy="scroll" data-target=".site-navbar-target"
   ...
   <section id="home-section" class="hero">
	...
	<section class="ftco-section testimony-section"> <img
		src="${pageContext.request.contextPath}/resources/images/blob-shape-2.svg"
		class="svg-blob" alt="Colorlib Free Template"> <img
		src="${pageContext.request.contextPath}/resources/images/blob-shape-2.svg"
		class="svg-blob-2" alt="Colorlib Free Template">
	<div class="container">
