               ...
               <div class="col-lg align-items-end" >
                  <div class="form-group">
                     <div class="form-field"style="text-align: center; padding-bottom:10px;">
                        ...
                        <input type="text" style="width: 40%; display: inline;" class="form-control" id="user_id" name="user_id" placeholder="ID" required>
               ...
               <div class="col-lg align-items-end">
                  <div class="form-group">
                     <div class="form-field" style="text-align: center;">
                        ...
                        <input type="password" style="width: 40%; display: inline;" class="form-control checkin_date" id="user_password" name="user_password" placeholder="Password" required>
