		...
		<div class="row no-gutters slider-text align-items-end justify-content-start">
			<div class="col-md-9 ftco-animate pb-4">
				...
				<p class="breadcrumbs">
					...
					<span class="mr-2"><a href="../Notice">Notice <i class="ion-ios-arrow-forward"></i></a></span>
		...
		<div class="comment-form-wrap pt-5">
			...
			<form action="/NoticeModifyProcess" class="p-5 bg-light">
				<div class="form-group">
					<label for="name">Title</label> <input type="text" class="form-control" name="board_title" id="board_title" value="${modify.board_title }">
				</div>

				<div class="form-group">
					<label for="message">Notice</label>
					<textarea name="board_content" id="board_content" cols="30" rows="10" class="form-control"></textarea>
				</div>
				
				<div class="form-group">
					<input type="hidden" name="board_no" id="board_no" value="${modify.board_no}" /> 
