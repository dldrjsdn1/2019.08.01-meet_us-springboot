...
@Component
public class MAmazonS3ClientServiceImpl implements MAmazonS3ClientService 
{
	
    private String awsS3AudioBucket;
    private AmazonS3 amazonS3;
    private static final Logger logger = LoggerFactory.getLogger(MAmazonS3ClientServiceImpl.class);

    @Autowired
    public MAmazonS3ClientServiceImpl(Region awsRegion, AWSCredentialsProvider awsCredentialsProvider, String awsS3AudioBucket) 
    {
