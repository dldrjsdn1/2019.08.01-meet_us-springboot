      ...
      <div
         ...
         <div class="col-md-9 ftco-animate pb-4">
            ...
            <p class="breadcrumbs">
               ...
               </span> <span class="mr-2"> <a href="../Notice">Login<i class="ion-ios-arrow-forward"></i></a>
               </span>
            </p>
         </div>
      </div>
...
<!-- 				<div class="form-group"> -->
<!-- 					<input type="text" class="form-control" name="user_password" id="user_password" placeholder = "비밀번호"> -->
<!-- 				</div> -->
